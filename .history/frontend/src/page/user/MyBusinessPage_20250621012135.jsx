      ...
      try {
        ...
        if (!Array.isArray(businesses)) {
          if (businesses.data && Array.isArray(businesses.data)) {
            businesses = businesses.data; // Nếu API trả về { data: [...] }
          } else if (
            businesses.businesses &&
            Array.isArray(businesses.businesses)
          ) {
            businesses = businesses.businesses; // Nếu API trả về { businesses: [...] }
          } else {
            throw new Error('Dữ liệu từ API không phải là mảng doanh nghiệp.');
          }
        }

        console.log('Businesses data:', businesses); // Kiểm tra cấu trúc dữ liệu
