  ...
  useEffect(() => {
    const fetchBusinessData = async () => {
      ...
      try {
        ...
        console.log('API Response:', businessesResponse); // Debug full response
        ...
        if (!userBusiness) {
          ...
          setError(
            `Không tìm thấy doanh nghiệp nào cho user với ID: ${userId}. Các user_id trong database: ${
              availableUserIds || 'Không có'
