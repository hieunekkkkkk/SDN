...
import { FaPlus } from 'react-icons/fa'; // Thêm icon FaPlus
  ...
  const handleSaveImages = async () => {
    if (newImages.length > 0 && selectedProduct) {
      ...
      try {
        ...
        setError(
          'Không thể lưu ảnh. Vui lòng kiểm tra kết nối hoặc định dạng ảnh.'
        );
      } finally {
        setLoading(false);
      }
            ...
            <div className="business-content">
              <div className="business-images">
                <div className="main-image">
                  <img
                    src={allThumbnails[selectedImage] || '1.png'} // Fallback nếu không có ảnh
                    alt={`${selectedProduct.name} main ${selectedImage + 1}`}
                    className="main-img"
                    onError={(e) => (e.target.src = '1.png')} // Fallback nếu ảnh lỗi
                  />
                </div>
                <div className="thumbnail-images">
                  {allThumbnails.map((thumb, idx) => (
                    ...
                    >
                      <img
                        src={thumb || '1.png'} // Fallback nếu thumb undefined
